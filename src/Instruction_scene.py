...
class Instruction_Scene(Scene):
    def __init__(self, app):
        ...
        self.title_rect.center = (app.width // 2, app.height // 2 - 200)
        ...
        self.subtitle_rect.center = (app.width // 2, app.height // 2 - 120)
        ...
        self.subtitle2_rect.center = (app.width // 2, app.height // 2 - 80)
        ...
        self.subtitle3_rect.center = (app.width // 2, app.height // 2 - 40)
        ...
        self.subtitle4_rect.center = (app.width // 2, app.height // 2)
        ...
        self.subtitle5_rect.center = (app.width // 2, app.height // 2 + 40)
        ...
        self.subtitle6_rect.center = (app.width // 2, app.height // 2 + 80)
        ...
        self.subtitle7_rect.center = (app.width // 2, app.height // 2 + 120)
        ...
        self.subtitle8_rect.center = (app.width // 2, app.height // 2 + 160)
        ...
        self.subtitle9_rect.center = (app.width // 2, app.height // 2 + 240)
