...
class Instruction_Scene(Scene):
    def __init__(self, app):
        ...
        self.subtitle9 = app.font.render("Presiona Enter para volver al menu principal.", True, (255,255,255))
        self.subtitle9_rect = self.subtitle9.get_rect()
        self.subtitle9_rect.center = (app.width // 2, app.height // 2 + 200)
        self.subtitle10 = app.font.render("Presiona la barra espaciadora para iniciar el juego.", True, (255,255,255))
